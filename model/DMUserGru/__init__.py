...
from model.DMUserGru.news_encoder import NewsEncoder
from model.DMUserGru.user_encoder import UserEncoder
from model.general.click_predictor.dot_product import DotProductClickPredictor


class DMUserGru(DMBase):
    def __init__(self, config, pretrained_word_embedding=None, writer=None):
        super(DMUserGru, self).__init__(config)
