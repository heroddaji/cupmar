...
from model.DMCateContext.news_encoder import NewsEncoder
from model.DMCateContext.user_encoder import UserEncoder
from model.general.click_predictor.dot_product import DotProductClickPredictor


class DMCateContext(DMBase):
    def __init__(self, config, pretrained_word_embedding=None, writer=None):
        super(DMCateContext, self).__init__(config)
